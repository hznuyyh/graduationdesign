...
return [
    ...
    'upload' => [
        ...
        'videoPathFormat' => '/uploads/video/'.date('Y-m-d').'/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        'videoUrlPrefix' => '47.95.205.248', /* 视频访问路径前缀 */
        ...
        'filePathFormat' => '/uploads/file/'.date('Y-m-d').'/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
